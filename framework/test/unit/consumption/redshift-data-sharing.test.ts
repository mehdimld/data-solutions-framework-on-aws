      ...
      Delete: Match.exact({
        'Fn::Join': [
          ...
          [
            ...
            '","ConsumerIdentifier":"222222222222"},"logApiResponseData":true}',
          ],
        ],
      }),
    });
      ...
      Create: Match.exact({
        'Fn::Join': [
          ...
          [
            ...
            '"},"physicalResourceId":{"id":"AssocDataShareConsumer-111111111111-1234-5678-9012"},"logApiResponseData":true}',
          ],
        ],
      }),
      Delete: Match.exact({
        'Fn::Join': [
          ...
          [
            ...
            '","DisassociateEntireAccount":false},"logApiResponseData":true}',
          ],
        ],
      }),
    });
