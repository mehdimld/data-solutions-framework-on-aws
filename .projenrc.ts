...
const sparkDataLakeInfraExampleApp = new awscdk.AwsCdkPythonApp({
  ...
  version: '0.0.1',
  description: 'An example CDK app demonstrating the most common.py use cases for DSF on AWS',
  authorName: author,
...
const adsfQuickstart = new awscdk.AwsCdkPythonApp({
  ...
  version: '0.0.1',
  description: 'An example CDK app demonstrating the most common.py use cases for Data Solutions Framework on AWS',
  authorName: author,
  authorEmail: authorAddress,
  license,
